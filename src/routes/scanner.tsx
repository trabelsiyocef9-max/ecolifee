  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground antialiased">
      ...
      <section className="mx-auto w-full max-w-5xl px-6 py-16 md:px-10 md:py-24">
        ...
        {recipe && !generating && (
          <div dir={recipeLang === "Arabic" ? "rtl" : undefined} className="mt-12 rounded-2xl border border-[#E5E3D8] bg-card/70 p-10 shadow-[var(--shadow-elegant)] backdrop-blur-md">
            <div className="mb-6 flex items-start gap-3 rounded-xl border border-amber-400/40 bg-amber-50/70 px-4 py-3 text-sm text-amber-900">
              <span aria-hidden="true" className="text-lg leading-none">⚠️</span>
              <p className="font-light leading-relaxed">
                This recipe was generated by AI and has not been verified by a safety expert. Always read all steps before starting. Adult supervision is recommended when using any tools. EcoLife is not liable for injuries resulting from following these instructions.
              </p>
            </div>
